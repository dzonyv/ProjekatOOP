...
function addNewElements(){  
    ...
    matchtile.classList.add("list");

    var naslov = document.createElement('p');
    naslov.innerHTML=data['data']['title'];

    var opis=document.createElement('p');
    opis.innerHTML=data['data']['description'];

    list.appendChild(naslov);
    list.appendChild(opis);
    xy.appendChild(list);
}  
...
/*    var fun=document.getElementById("dugme");
